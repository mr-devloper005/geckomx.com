...
export const editableRootStyle = {
  '--slot4-page-bg': '#f4f8fc',
  '--slot4-page-text': '#0b1930',
  '--slot4-panel-bg': '#e9f1f8',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#60708a',
  '--slot4-soft-muted-text': '#91a0b4',
  '--slot4-accent': '#c87922',
  '--slot4-accent-fill': '#c87922',
  '--slot4-accent-soft': '#fff1dd',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#08213b',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfeaf3',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#edf5fb',
  '--slot4-lavender': '#e7eef8',
  '--slot4-gray': '#f5f8fb',
  '--slot4-body-gradient': 'linear-gradient(180deg,#f7fbff 0%,#edf5fb 42%,#ffffff 100%)',
  '--editable-page-bg': '#f4f8fc',
  '--editable-page-text': '#0b1930',
  '--editable-container': '1500px',
  '--editable-border': '#cfdae7',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#0b1930',
  '--editable-nav-active': '#c87922',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#c87922',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#ffffff',
  '--editable-footer-text': '#0b1930',
} as CSSProperties
