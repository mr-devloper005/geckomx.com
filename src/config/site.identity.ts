export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'geckomx',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Geckomx',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'geckomx.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://geckomx.com',
